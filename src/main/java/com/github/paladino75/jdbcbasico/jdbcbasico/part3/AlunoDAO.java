...
public class AlunoDAO {
    ...
    public List<Aluno> list() {
        ...
        try(Connection conn = ConnectionFactory.getConection()) {
            ...
            pois irá todos os valores da tabela aluno.*/
            ...
            System.out.println("Listaagem de alunos FALHOU!");
            e.printStackTrace();
        }
    ...
    public void create(Aluno aluno) {
        try (Connection conn = ConnectionFactory.getConection()) {
            ...
            System.out.println("Inserção BEM SUCEDIDA!. adicionada." + rowsAffected + "linha");
        } catch (SQLException e) {
    ...
    public void delete(int id) {
        try (Connection conn = ConnectionFactory.getConection()) {
            ...
            //Executa delete e armazena o numeros de linhas afetadas
            int rowsAffected = stmt.executeUpdate();
